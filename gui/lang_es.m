...
list{132} = 'Curva de dispersión calculada vs experimental';
list{133} = 'Perfil de velocidad de corte vs profundidad';
list{134} = 'Curva de velocidad de fase vs iteraciones';
list{135} = 'Parámetros iniciales';
list{136} = 'Parámetro mu';
list{137} = 'Parámetro sigma';
list{138} = 'Número máximo de iteraciones max_iter';
list{139} = 'Tolerancia de vs, tol_vs';
list{140} = 'Perfil de velocidad de corte vs estimación inicial';
list{141} = 'Error: Ocurrió un error al generar la comparación de la velocidad de corte.';
list{142} = 'Comparación perfil de velocidad de corte vs estimación inicial';
list{143} = 'Velocidad de corte';
list{144} = '_resultados.xls';
list{145} = 'Ver tabla de dispersión';
list{146} = 'Tabla de dispersión';
list{147} = 'Cerrar';
list{148} = 'Licencia: GPL-2.0';
list{149} = '';
list{150} = '';
% --------------------------------------------------------------------
