...
list{121} = 'Préférences';
list{122} = 'Configuration de l''application';
list{123} = 'Langue';
list{124} = 'Activer le son';
...
list{129} = 'Configuration de la solution';
list{130} = 'Paramètres d''inversion';
list{131} = 'Paramètres graphiques';
list{132} = 'Courbe de dispersion calculée par rapport expérimental';
list{133} = 'Coupe profil de vitesse vs profondeur';
list{134} = 'Phase vitesse courbe vs itérations';
list{135} = 'Paramètres initiaux';
list{136} = 'Coefficient mu';
list{137} = 'Coefficient sigma';
list{138} = 'Nombre maximal d''itérations max_iter';
list{139} = 'Tolérance de vs, tol_vs';
list{140} = 'Profil vitesse de coupe vs estimation initiale';
list{141} = 'Erreur: Une erreur est survenue lors de la génération de la comparaison de la vitesse de coupe.';
list{142} = 'Comparaison vitesse profil de coupe vs estimation initiale';
list{143} = 'Vitesse de coupe';
list{144} = '_résultats.xls';
